...
const NavigationBar: React.FC<NavigationBarProps> = ({ color, openModal }) => {
  ...
  return (
    <div
      className={`z-10 flex w-full max-w-lg items-center justify-between rounded-[2.5rem] px-[2.5rem] py-[0.7rem] shadow-base transition-all duration-500 ease-in-out sm:px-[3.5rem] sm:py-[0.5rem] ${variants[color].bg}`}
    >
      <Search
